# Generated by Django 3.0.7 on 2020-11-04 03:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Condicion',
            fields=[
                ('idCondicion', models.AutoField(help_text='ID unico', primary_key=True, serialize=False, verbose_name='ID CONDICION PAQUETE')),
                ('tituloCondicion', models.CharField(blank=True, max_length=250, null=True, verbose_name='Titulo')),
                ('descripcionCondicion', models.TextField(blank=True, max_length=1000, null=True, verbose_name='Descripcion de la condicion')),
                ('estadoCondicion', models.BooleanField(default=True, verbose_name='Es Activo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mesPaquete', models.CharField(blank=True, choices=[('Enero', 'Enero'), ('Febrero', 'Febrero'), ('Marzo', 'Marzo'), ('Abril', 'Abril'), ('Mayo', 'Mayo'), ('Junio', 'Junio'), ('Julio', 'Julio'), ('Agosto', 'Agosto'), ('Septiembre', 'Septiembre'), ('Octubre', 'Octubre'), ('Noviembre', 'Noviembre'), ('Diciembre', 'Diciembre'), ('Todos los meses', 'Todos los meses')], default='Todos los meses', max_length=15, null=True, verbose_name='Mes de Disponiblidad')),
                ('disponibilidadPaquete', models.PositiveSmallIntegerField(blank=True, default=150, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100)], verbose_name='Numero de Cupos')),
                ...
                ('estadoPaquete', models.BooleanField(blank=True, default=True, null=True, verbose_name='Activo')),
                ('condicion_paquete', models.ManyToManyField(to='Reservacion.Condicion', verbose_name='Condiciones')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nroDiaDetallePaquete', models.PositiveSmallIntegerField(default=1, null=True, verbose_name='Numero de Dia')),
